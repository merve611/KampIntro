...
namespace MernisServiceReference1
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference1.KPSPublicSoap>, MernisServiceReference1.KPSPublicSoap
    {
        ...
        public MernisServiceReference1.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(long v, MernisServiceReference1.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrula(request);
        }
        
        public System.Threading.Tasks.Task<MernisServiceReference1.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long v, MernisServiceReference1.TCKimlikNoDogrulaRequest request)
        {
        ...
        internal bool TCKimlikNoDogrula(long v1, string v2, string v3, int year)
        {
